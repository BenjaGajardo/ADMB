...
select nombre_tipo from usuarios
where nombre_tipo like 'b%';

select nombre_tipo, created_at from usuarios
where created_at between '2025-05-18' and '2025-05-20' ;

SELECT * FROM usuarios
WHERE nombre_tipo LIKE '%reyes%' OR nombre_tipo LIKE '%benja%';
